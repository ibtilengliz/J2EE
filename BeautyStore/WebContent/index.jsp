...
<!--  this is a test -->
  ...
  <!-- Fin topnav menu -->
       <!-- Body -->
        <div class="container">
  <center>
            <img src="RL1.jpg" id="rl1"><br>
      <label for="rl1" >Rouge à lèvres 100% Matt <br>ref n°01<br>25 NV <strike>30dt</strike><br>
       ...
       <label for="pack1" >Pack l'oréal 5pièces <br>ref n°02<br>NOUVEAU<br>
          <button type="submit" class="btn btn-warning">Acheter</button>
            ...
            <img src="RL2.jpg"><br>
      <label for="rl2" >Gloss NYX  <br>ref n°05<br>Edition limitée <br>20 <strike>25dt</strike><br>
          <button type="submit" class="btn btn-warning">Acheter</button>
      ...
      <img src="PACK2.jpg"><br>
       <label for="pack2" >Pack All In One de NYX <br>ref n°15<br>
          <button type="submit" class="btn btn-warning">Acheter</button>
            ...
            <img src="FDT1.jpg"><br>
      <label for="rl1" >Fond de teint NYX 100% naturel <br>ref n°12<br> <strong style="font-size:20px;">Black Friday !! </strong><br>
          <button type="submit" class="btn btn-warning">Acheter</button>
